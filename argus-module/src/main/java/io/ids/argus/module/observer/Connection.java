...
public class Connection implements StreamObserver<OpenResponse> {
    private final ArgusLogger log = new ArgusLogger(Connection.class);
    private final CountDownLatch countDownLatch = new CountDownLatch(1);
    private final ArgusModule module;
    private Status status;
    private final ObserverListener listener;

    public Connection(ArgusModule module, ObserverListener listener) {
        this.module = module;
